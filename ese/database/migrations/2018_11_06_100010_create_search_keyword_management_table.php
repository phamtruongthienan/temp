...
class CreateSearchKeywordManagementTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('m_keyword_search_translation', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('m_keyword_search_translation', function (Blueprint $table) {
            $table->foreign('language_id')->references('id')->on('config_language');
            $table->foreign('translation_id')->references('id')->on('m_keyword_search');
        });
