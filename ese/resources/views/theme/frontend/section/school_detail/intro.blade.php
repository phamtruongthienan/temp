            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="div-block-1151" style="margin-top:10px" id="MapD">
                        <a class="address-link-2" target="_blank" href="https://www.google.com/maps/search/{{ urlencode($school_detail[0]->mSchooltranslations[0]->name.', '.$school_detail[0]->mSchooltranslations[0]->address) }}" class="link-7" style="font-size:13px">
                            <i class="fas fa-map-marked-alt"></i> {{$school_detail[0]->mSchooltranslations[0]->address}} - <span style="text-decoration: underline;font-weight:700">Xem trên bản đồ</span>
                        </a>
                    </div>
                ...
                <div class="col-4" style="text-align: center;margin-top: 20px;">
                        <div style="margin-bottom: 20px;">
                                ...
                                @endphp
                            <span class="badge badge-primary" style="margin-right:10px;font-size:15px">Rating: {{round($count/$index)}}/10</span>
                            <span class="badge badge-primary" style="margin-right:10px;font-size:15px">Reviews: {{$school_detail[0]->review}}</span>
                        </div>
