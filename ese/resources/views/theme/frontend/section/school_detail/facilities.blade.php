        ...
        <div class="div-block-1270">
            <div class="div-block-1278">
                ...
                <div class="div-block-1269">
                    ...
                    @else
                    <a href="{{asset('login')}}?ref={{request()->path()}}" class="button-11 w-button"> Login to view<br></a>
                    @endif
                </div>
                @endif
                                        ...
                                        @if($val->end_date >= $now)
                                            <div class="div-block-1189">
                                                ...
                                                <div class="div-block-1194-copy">
                                                    ...
                                                    <div class="text-block-product-opening">{{$val->mSchoolprograms[0]->time}}
                                                        {{trans('front.school.detail.unit'.$val->mSchoolprograms[0]->unit_1)}}
                                                        / {{trans('front.school.detail.unit'.$val->mSchoolprograms[0]->unit_2)}}
                                                    </div>
                                                </div>
                                                <div class="div-block-1194-copy">
                                                    <div class="icon money"></div>
                                                    <div class="text-block-product-opening">{{number_format($val->mSchoolprograms[0]->fee)}} {{ $config_language[0]->currency_code }}
                                                        / {{$val->mSchoolprograms[0]->unit_4}} {{trans('front.school.detail.unit'.$val->mSchoolprograms[0]->unit_3)}}</div>
                                                </div>
                                            </div>
                                        @endif
                                    @else
