        ...
        <div class="product">
          ...
          <div class="div-block-1177">
            <div class="list-div">
                ...
                <div class="text-block-32"><b class="text-danger">{{$v->review}} </b><span class="margin-left-5">reviews</span><br></div>
              </div>
              
            <a href="{{asset($v->mSchooltranslations[0]->slug)}}" class="button-8 w-button">View more</a></div>
        </div>
      @endforeach
    @endif
