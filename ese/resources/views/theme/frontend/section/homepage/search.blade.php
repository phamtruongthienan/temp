    ...
    <div class="love-container w-container">
        ...
        <div class="block-search">
            ...
            <div class="div-block-1111"><a href="#" data-toggle="tooltip" data-placement="top"
                                           ...
                                           class="button-7 w-button btn-search-advanced" data-current="{{mb_strtoupper(trans('front.homepage.search.advanced'))}}" data-next="{{trans('front.homepage.search.basicsearch')}}">{{mb_strtoupper(trans('front.homepage.search.advanced'))}}</a>
