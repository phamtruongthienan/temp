<!-- Edit modal employee -->
<div class="modal fade" id="modal-room-edit" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_vn_edit">
                            <form class="form-horizontal" id="editRoomForm" role="form" data-toggle="validator">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="inputEditPosition" value=""
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="editRoomBtn"
