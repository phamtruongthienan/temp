<!-- Add modal customer -->
<div class="modal fade" id="modal-level-add" data-backdrop="static">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_vn_edit">
                            <form class="form-horizontal" id="addLevelForm" role="form" data-toggle="validator">
