            ...
            <div class="nav-tabs-custom posr">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="listRoom">
                        <a class="text-green cursor-pointer posa" id="addRoom">
                        ...
                        @include('theme.backend.section.room.modal_edit_room')
                    </div>
                    <!-- /.tab-pane -->
                </div>
                <!-- /.tab-content -->
...
@section('script')
    <script src="{{asset('assets/backend/js/pages/room.min.js')}}"></script>
@endsection