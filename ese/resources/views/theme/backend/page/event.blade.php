            ...
            <div class="nav-tabs-custom posr">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="listEvent">
                        <a class="text-green cursor-pointer posa" id="addEvent">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-success alert-dismissible no-display" id="alert_msg">
                                    ...
                                    <i class="icon fa fa-check"></i> Thêm sự kiện thành công.
                                </div>
                                <div class="alert alert-success alert-dismissible no-display" id="alert_msg_edit">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <i class="icon fa fa-check"></i> Cập nhật sự kiện thành công.
                                </div>
                            </div>
                        </div>
                        <!-- row -->
                        ...
                        @include('theme.backend.section.event.modal_edit_event')
                    </div>
                    <!-- /.tab-pane -->
                </div>
                <!-- /.tab-content -->
...
@section('script')
    <script src="{{asset('assets/backend/js/pages/event.min.js')}}"></script>
@endsection