    ...
    <div class="container w-container">
        <div class="row-2 w-row">
            <div class="col-foot w-col w-col-3 w-col-small-6 w-col-tiny-tiny-stack">
                <a href="{{ asset('booking') }}" class="link _1">Booking for visit</a>
                <a href="{{ asset('schools') }}" class="link _1">School &amp; Course</a>

            </div>
            <div class="col-foot w-col w-col-3 w-col-small-6 w-col-tiny-tiny-stack">
                <a href="{{ asset('promotion') }}" class="link _2">Promotion</a>
                <a href="{{ asset('sitemap') }}" class="link _1">Sitemap</a>
            </div>
            <div class="col-foot w-col w-col-3 w-col-small-6 w-col-tiny-tiny-stack">
                @if(!empty($menu))
                    @foreach($menu as $k => $v)
