...
$(function() {
    ...
    var searchPrice = [{
            ...
            value: 1,
            selected: false,
            description: "Học phí từ 1 đến 5 triệu đồng",
        }, {
            text: "5 - 10 triệu",
            value: 2,
            selected: false,
            description: "Học phí từ 5 đến 10 triệu đồng",
        }, {
            text: "10 - 15 triệu",
            value: 3,
            selected: false,
            description: "Học phí từ 10 đến 15 triệu đồng",
        }, {
            text: "15 triệu +",
            value: 4,
            selected: false,
            description: "Học phí từ 15 triệu đồng trở lên",
        },
    ...
    $('#price').ddslick({
        data: searchPrice,
        imagePosition: "left",
        selectText: "<div class='select-holder'><i class='fas fa-dollar-sign'></i> Học phí</div>",
    });

    $('#language').ddslick({
        data: searchLanguage,
        imagePosition: "left",
        selectText: "<div class='select-holder'><i class='fas fa-globe-americas'></i> Ngôn ngữ</div>",
    });
    ...
    var searchRating = [{
            ...
            value: 1,
            selected: false,
            description: "Tìm kiếm với <i class='fas fa-star text-warning'></i>",
        }, {
            text: "2 <i class='fas fa-star text-warning'></i>",
            value: 2,
            selected: false,
            description: "Tìm kiếm với <i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i>",
        }, {
            text: "3 <i class='fas fa-star text-warning'></i>",
            value: 3,
            selected: false,
            description: "Tìm kiếm với <i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i>",
        }, {
            text: "4 <i class='fas fa-star text-warning'></i>",
            value: 4,
            selected: false,
            description: "Tìm kiếm với <i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i>",
        }, {
            text: "5 <i class='fas fa-star text-warning'></i>",
            value: 5,
            selected: false,
            description: "Tìm kiếm với <i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i><i class='fas fa-star text-warning'></i>",
        },
    ...
    $('#rating').ddslick({
        data: searchRating,
        imagePosition: "left",
        selectText: "<div class='select-holder'><i class='fas fa-star'></i> Đánh giá</div>",
    });

    $('#type').ddslick({
        data: searchSchoolType,
        imagePosition: "left",
        selectText: "<div class='select-holder'><i class='fas fa-school'></i> Loại trường</div>",
    });

    $('#level').ddslick({
        data: searchSchoolLevel,
        imagePosition: "left",
        selectText: "<div class='select-holder'><i class='fab fa-fort-awesome'></i> Cấp trường</div>",
    });
