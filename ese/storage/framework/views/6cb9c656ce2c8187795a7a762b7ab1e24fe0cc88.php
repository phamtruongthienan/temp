                                ...
                                <div class="nav-tabs-custom posr">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_type_priority">
                                            <?php echo $__env->make('theme.backend.section.search.tab_priority', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        </div>
                                        <!-- /.tab-pane -->
                                        <div class="tab-pane" id="tab_list_school">
                                            <?php echo $__env->make('theme.backend.section.search.tab_school', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        </div>
                                        <!-- /.tab-pane -->
                                    </div>
                                    <!-- /.tab-content -->
