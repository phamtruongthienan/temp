<div class="main-section">
    <div class="main-container w-container">
        <div class="div-block-breadcumb"><a href="index.html" class="link-breadcumb-2">Home</a>
            ...
            <a href="<?php echo e(asset('/'.$view->slug)); ?>" class="link-breadcumb-now-2 w--current"><?php echo e($view->title); ?></a></div>
            ...
            <div class="child-2">
                <div class="boder">
                    <div>
                        ...
                        <div class="div-block-92">
                            ...
                            <div class="text-block-38">Address:</div>
                        </div>
                        ...
                        <div class="row-15 w-row">
                            ...
                            <div class="column-16 w-col w-col-4">
                                <div class="div-block-92">
                                    ...
                                    <div class="text-block-38">Phone</div>
                                </div>
                ...
                <div class="form-block-8 w-form">
                    <form id="form-contact" name="form-contact" data-name="Email Form" role="form"
                        ...
                        <label for="name-2" class="field-label"><?php echo e(trans('front.homepage.contact.youremail')); ?> <strong
                                    class="bold-text-12">*</strong></label>
                        <div class="form-group">
                            <input type="text" id="emailContact" name="emailContact" maxlength="256"
                                   class="text-field w-input" required data-required-error="<?php echo e(trans('front.homepage.contact.erroryouremail')); ?>">
                            <div class="help-block with-errors"></div>
                        </div>
                        <label class="field-label"><?php echo e(trans('front.homepage.contact.youneed')); ?>  <strong
                                    class="bold-text-12">*</strong><br></label>
                        <div class="form-group">
                            <select id="selectContact" name="selectContact" class="select-field w-select" required
                                    data-required-error="<?php echo e(trans('front.homepage.contact.erroryouneed')); ?>">
                        ...
                        <label class="field-label"><?php echo e(trans('front.homepage.contact.subject')); ?>  <strong class="bold-text-12">*</strong><br></label>
                        <div class="form-group">
                            <input type="text" id="subjectContact" name="subjectContact" maxlength="256"
                                   class="text-field w-input" required data-required-error="<?php echo e(trans('front.homepage.contact.errorsubject')); ?>">
                            <div class="help-block with-errors"></div>
                        </div>
                        <label class="field-label"><?php echo e(trans('front.homepage.contact.message')); ?>  <strong class="bold-text-12">*</strong><br></label>
                        <div class="form-group">
                            <textarea id="messageContact" name="messageContact" maxlength="5000" class="textarea-2 w-input" required
                                      data-required-error="<?php echo e(trans('front.homepage.contact.errormessage')); ?>"></textarea>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="col-lg-7 col-xl-7 col-md-7 col-sm-12 col-12">
                            ...
                            <input value="Submit" data-wait="Please wait..." class="button-2 w-button" id="sendContactBtn">
                    </div>                    
                </div>
            </div>
        </div>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('assets/frontend/js/contact.js')); ?>" type="text/javascript"></script>
