<div class="div-block-1275">
    <div class="text-block-97" style="text-shadow: 2px 4px 3px rgba(0,0,0,0.3);;background: rgba(0,0,0,0.4);padding: 20px;"><?php echo e(mb_strtoupper($school_detail[0]->mSchooltranslations[0]->slogan)); ?></div>
    <a class="button-13 w-button btn-booking" 
    style="background-image: linear-gradient(45deg, #f04e23, #ffd600), linear-gradient(180deg, #f04e23, #f04e23);background-color: unset !important;" data-toggle="modal" data-target="#booking"><?php echo e(trans('front.homepage.intro.booking')); ?></a>
</div>
...
<div data-delay="4000" data-animation="slide" data-autoplay="1" data-duration="500" data-infinite="1"
    ...
    <div class="w-slider-mask">
        <?php $__currentLoopData = $school_detail[0]->mSchoolimages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($val->is_cover == 1): ?>

                <div class="w-slider-mask-item">
                    <div class="w-slide" style="background-image:url(<?php echo e(asset('img/'.$val->image)); ?>);background-position: center;background-size: cover;"></div>
                </div>
            <?php endif; ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
            <h4 class="modal-title"><?php echo e($school_detail[0]->mSchooltranslations[0]->name); ?></h4>
        ...
        <div class="div-block-80-copy">
              <div class="w-form">
                <form id="bookingForm" name="bookingForm" data-name="Email Form">
                    ...
                    <input type="hidden" id="schoolId" name="schoolId" value="<?php echo e($school_detail[0]->id); ?>">
                    <?php if(!Auth::check()): ?>
                        <div class="div-block-book-school" style="margin-top:0px; padding-top:0px">
                            ...
                            <a href="<?php echo e(asset('login')); ?>" class="link-block-13 w-inline-block">
                    ...
                    <?php else: ?>
                        <label for="name-3" class="field-label">Or fill this form<br></label>
                        <label for="bookingName" class="field-label">Your name <strong class="bold-text-25">*</strong><br></label>
                        <input type="text" id="bookingName" name="bookingName" data-name="Name 2" maxlength="256" class="text-field w-input" value="<?php echo e(Auth::user()->name); ?>">
                        <label for="bookingPhone" class="field-label">Your Phone <strong class="bold-text-25">*</strong><br></label>
                        <input type="text" id="bookingPhone" name="bookingPhone" data-name="Name 2" maxlength="256" class="text-field w-input" value="<?php echo e(Auth::user()->phone); ?>">
                        <label for="bookingEmail-3" class="field-label">Your email <strong class="bold-text-25">*</strong><br></label>
                        <input type="text" id="bookingEmail" name="bookingEmail" data-name="Name 2" maxlength="256" class="text-field w-input" value="<?php echo e(Auth::user()->email); ?>">
                    <?php endif; ?>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('assets/frontend/js/booking.js')); ?>" type="text/javascript"></script>
